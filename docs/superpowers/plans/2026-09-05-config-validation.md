...
- [ ] Add Editor `IPreprocessBuildWithReport` hook reading `Application.streamingAssetsPath/game-config.json`, throws BuildFailedException on missing/invalid config. Shared parser must be used, no duplicate rules.
